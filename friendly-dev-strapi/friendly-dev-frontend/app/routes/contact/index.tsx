...
const ContactPage = ({actionData}: Route.ComponentProps) => {
  ...
  return (
    <div className='max-w-3xl mx-auto mt-12 px-6 py-8 bg-gray-900 '>
        <h2 className="text-3xl text-white font-bold mb-8 text-center">📫 Contact</h2>

        {actionData?.message ? (<p className="mb-6 p-4 bg-green-700 text-green-100 text-center rounded-lg border border-green-500 shadow-md">{actionData.message}</p>) : null }
        ...
        <Form method="post" className="space-y-6">
          ...
          <button className="w-full bg-blue-600 hover:bg-blue-700 py-2 text-white rounded-lg cursor-pointer">Send Message</button>
        </Form>
    </div>
  )
}
